...
// React hooks can only be used in functional components or custom hooks.
...
function UpdateEmployee() {
  ...
  const saveEmployee = (e) => {
    ...
    userValidation
      ...
      .then((validUser) => {
        // formValid is the value we get after validation
      ...
      .catch((errors) => {
        // error is the value we get after validation
